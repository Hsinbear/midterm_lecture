...
// $resultCombine = $conn->query($sqlCombine);
// $rowCount = $resultCombine->num_rows;
// $combineRows = $resultCombine->fetch_all(MYSQLI_ASSOC);

// if ($resultCombine) {
//     // 将 $resultCombine 中的每一行添加到 $result 中
//     while ($rows = $resultCombine->fetch_assoc()) {
//         $result->fetch_array(MYSQLI_ASSOC);
//     }
// }


// var_dump($combineRows);
?>
                                        ...
                                        <nav aria-label="Page navigation example">
                                            <ul class="pagination d-flex justify-content-center">
                                                <?php for ($i = 1; $i <= $pageCount; $i++) : ?>
                                                    <li class="page-item <?php if ($i == $p) echo "active" ?>"><a class="page-link" href="lecture2.php?order=<?= $order ?>&p=<?= $i ?>"><?= $i ?></a></li>
                                                <?php endfor; ?>
                                            </ul>
                                        </nav>
                                    <?php endif ?>
